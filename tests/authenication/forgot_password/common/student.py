...
class StudentForgotPasswordClass(BaseTestClass):
    ...
    @allure.title("Checking page title is correct")
    @allure.severity(allure.severity_level.MINOR)
