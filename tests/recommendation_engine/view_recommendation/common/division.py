...
@allure.feature("View Recommendations")
@allure.suite("Recommendation Division Login")
@allure.description("Test cases for view recommendations")
class DivisionOwnerRecommendationsClass(BaseTestClass):
    ...
    @allure.title("Validate advisor dashboard screen url")
    @allure.severity(allure.severity_level.CRITICAL)
